...
public class SearchByPublishing implements Command {
	...
	public String execute(String request) {
			...
			publishing = request.substring(request.indexOf("publishing") + 7);
			...
			try {
				response = searchService.searchBookByAuthor(publishing);
